    ...
    function fillTableTbody(data, plotColors, groupId) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            */
            ...
            if (groupId == 0) {
                //html += '<td><a href="/sal_sales/graphics_purchases_products/groupName:' + data[i]["label"] + '/groupId:' + data[i]["id"] + '/groupType:' + jQuery("#cbxGroup").val() + '" target="_blank">' + data[i]["label"] + '</a></td>';
                ...
                html += '/month:' + getSelectedAsString("#PurPurchaseGraphicsPurchasesProductsForm #cbxMonth option:selected");
