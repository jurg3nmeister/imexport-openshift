	...
	<table class="report-table" border="1" style="border-collapse:collapse; width:100%;">
		<?php if($countMovements == 1){?>
			...
			<thead>
				...
				<tr> <th style="width:100%" colspan="14">Movimientos</th></tr>
				<tr>
					<th>Fecha</th>
					<th>Codigo</th>
					<th>Codigo <br> Ref</th>
					...
					<th>P.Venta x Cant. <br><?php echo 'Con Descuento'.$currencyAbbr ; ?></th>
				</tr>
			...
			<tbody>
				<?php foreach($val['Movements'] as $movement){?>
					...
					<tr style="text-align:center;">
						...
						<td style="font-weight:bold;"><?php echo number_format($movement['saleDiscount'],2);?></td>
					</tr>
					<?php } //end - detail YES?>
				...
				<tr style="text-align:center;font-weight:bold;">
					...
					<td ><?php echo number_format($val['TotalMovements']['saleDiscountTotal'],2); ?></td>
				</tr>
		<?php }else{?>
				<thead>
